...
information = {"--------------------------------------","","             INFORMATION","","--------------------------------------","","This is the server's pricelist.","","This list lists the lowest price you,","","as a player, can sell at.","","Of course you can sell above these","","prices.","","","","Use the buttons on the side","","and bottom to navigate.","","","","If you have any questions regarding","","this pricelist and its rules, ask","","the other players.","","If they also do not know it,","","then ask a staff member.",""}
